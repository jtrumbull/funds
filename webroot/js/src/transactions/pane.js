  ...
  var Pane = App.Pane.extend({
    ...
    initTable: function () {
      ...
      var table = new Table({
        ...
        pager: doc.getElementById('transactions-table-pager'),
        searchbox: doc.getElementById('transactions-toolbar-searchbox'),
      });
    ...
    initReadModal: function () {
      var modal = new ReadModal({
        el: doc.getElementById('transactions-read-modal')
      });
