  ...
  var Pane = App.Pane.extend({
    ...
    initTable: function () {
      ...
      var table = new Table({
        ...
        el: doc.getElementById('funds-table'),
        pager: doc.getElementById('funds-table-pager'),
        searchbox: doc.getElementById('funds-toolbar-searchbox'),
      });
    ...
    initToolbar: function () {
      var toolbar = new Toolbar({
        collection: this.collection,
        el: doc.getElementById('funds-toolbar')
      });
    ...
    initReadModal: function () {
      var modal = new ReadModal({
        el: doc.getElementById('funds-read-modal')
      });
    ...
    initCreateModal: function () {
      var modal = new CreateModal({
        el: doc.getElementById('funds-create-modal')
      });
